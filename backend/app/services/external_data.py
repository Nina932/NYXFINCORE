...
class ExternalDataService:
    ...
    async def get_competitor_pricing(self) -> Dict[str, Any]:
        ...
        competitors = {
            "socar": {
                "petrol_regular": Decimal("3.15"),
                "petrol_premium": Decimal("3.35"),
                "petrol_super":   Decimal("3.59"),
                "diesel":         Decimal("2.85"),
                "cng":            Decimal("1.95"),
                "lpg":            Decimal("1.75"),
                "stations":       120,
                "primary_supplier": "Heydar Aliyev Refinery (Baku)",
                "data_quality":   "estimated",
            },
            "rompetrol": {
                "petrol_regular": Decimal("3.16"),
                "petrol_premium": Decimal("3.38"),
                "petrol_super":   Decimal("3.62"),
                "diesel":         Decimal("2.84"),
                "lpg":            Decimal("1.78"),
                "stations":       85,
                "primary_supplier": "Petromidia Refinery (Romania)",
                "data_quality":   "estimated",
            },
            "gulf": {
                "petrol_regular": Decimal("3.18"),
                "petrol_premium": Decimal("3.42"),
                "petrol_super":   Decimal("3.65"),
                "diesel":         Decimal("2.83"),
                "lpg":            Decimal("1.80"),
                "stations":       145,
                "primary_supplier": "Multi-source (Ceyhan/Augusta/Sarroch)",
                "data_quality":   "estimated",
            },
            "lukoil": {
                "petrol_regular": Decimal("3.20"),
                "petrol_premium": Decimal("3.40"),
                "petrol_super":   Decimal("3.63"),
                "diesel":         Decimal("2.86"),
                "lpg":            Decimal("1.76"),
                "stations":       52,
                "primary_supplier": "Neftochim Burgas Refinery (Bulgaria)",
                "data_quality":   "estimated",
            },
            "wissol": {
                "petrol_regular": Decimal("3.14"),
                "petrol_premium": Decimal("3.36"),
                "petrol_super":   Decimal("3.58"),
                "diesel":         Decimal("2.82"),
                "cng":            Decimal("1.92"),
                "lpg":            Decimal("1.74"),
                "stations":       110,
                "primary_supplier": "TÜPRAŞ Refineries (Turkey)",
                "data_quality":   "estimated",
            },
        }
