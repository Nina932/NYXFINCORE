    ...
    <div className="landing-hero-bg min-h-screen text-text selection:bg-sky/30">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 landing-nav flex items-center justify-between px-8">
        ...
        <div className="hidden md:flex items-center gap-8 text-[10px] font-bold tracking-[0.2em] uppercase text-muted">
          ...
          <button 
            onClick={() => window.location.href = 'https://app.yourdomain.com'}
      ...
      >
        ...
        >
          ...
          <img 
            src="/assets/dashboard_risk_map_1775674115537.png" 
        ...
        <div className="feature-grid">
          ...
          >
            ...
            <div className="mt-4 image-reveal-container h-48">
              <img src="/assets/dashboard_risk_map_1775674115537.png" className="w-full h-full object-cover grayscale group-hover:grayscale-0" />
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="mt-4 image-reveal-container h-48">
              <img src="/assets/agent_workflow_analysis_1775674131932.png" className="w-full h-full object-cover grayscale group-hover:grayscale-0" />
            </div>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-20">
          ...
          <div className="flex-1 w-full flex justify-center translate-y-10 md:translate-y-0">
             <div className="image-reveal-container glass-premium p-4 max-w-md transform rotate-2">
                <img src="/assets/deep_reasoning_ai_1775673981431.png" alt="Intelligence Panel" className="rounded border border-white/5" />
             </div>
          </div>
        </div>
      </section>
