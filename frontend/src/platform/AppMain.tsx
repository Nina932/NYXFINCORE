/**
 * Main application entry — no marketing landing page.
 * Served from /app/ via app/index.html
 */
        ...
        <BrowserRouter basename="/app">
          <Routes>
            ...
            <Route element={<Layout />}>
              <Route index element={<ErrorBoundary compact fallbackTitle="Dashboard"><DashboardPage /></ErrorBoundary>} />
